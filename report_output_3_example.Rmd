...
PC1, PC2, PC3, etc.). You may run into the issue where your axis is
...
__Write a function, `make_biplot` that generates a *plot* of the first two
principal components labeled by their SixSubTypesClassification found in the
